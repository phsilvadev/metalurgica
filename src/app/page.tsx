...
import { ChevronDown, Calculator, Phone, Zap, Shield, Leaf, TrendingUp, Users, Wrench, Handshake, Menu, X } from 'lucide-react'
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
        ...
        <nav className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex flex-col">
            <h2 className="text-2xl font-bold text-red-600">EMBRAFER</h2>
            <span className="text-sm text-gray-600">Estruturas Metálicas</span>
          </div>
          
          <ul className="hidden md:flex space-x-8">
            {['home', 'services', 'about', 'gallery', 'careers', 'contact'].map((item) => (
              <li key={item}>
                {item === 'careers' ? (
                  <a
                    href="/careers"
      ...
      {/* Hero Section */}
      <section id="home" className="min-h-screen flex items-center bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 items-center relative z-10">
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              O poder do aço com uma empresa de confiança. Soluções completas em estruturas metálicas com qualidade, segurança e agilidade.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            {[
              { icon: Zap, title: 'Velocidade', desc: 'Estruturas pré-fabricadas que aceleram sua obra' },
              { icon: Shield, title: 'Segurança', desc: 'Máxima segurança e longevidade para seu projeto' },
              { icon: Leaf, title: 'Sustentabilidade', desc: 'Material 100% reaproveitável e ecologicamente correto' },
              { icon: TrendingUp, title: 'Economia', desc: 'Previsibilidade de custos e excelente custo-benefício' }
            ].map((feature, index) => (
            ...
            {[
              {
                ...
                items: ['Galpões industriais', 'Armazéns graneleiros', 'Coberturas esportivas']
              },
              {
                ...
                items: ['Casas e sobrados', 'Edifícios comerciais', 'Mezaninos']
              },
              {
              ...
              },
              {
                ...
                items: ['Escadas industriais', 'Passarelas de acesso', 'Guarda-corpos']
              }
            ].map((service, index) => (
              <div key={index} className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
      ...
      <section id="about" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h2 className="text-4xl font-bold text-gray-800">Por que escolher a Embrafer?</h2>
              <p className="text-lg text-gray-600 leading-relaxed">
                A Embrafer trabalha com estruturas metálicas em Balsas, nossos engenheiros estão preparados para qualquer desafio, sempre procurando atender todos os requisitos de qualquer obra.
              </p>
              
              <div className="space-y-6">
                {[
                  { icon: Users, title: 'Engenheiros Especializados', desc: 'Equipe preparada para elaboração de grandes e pequenos projetos' },
                  { icon: Wrench, title: 'Fabricação Própria', desc: 'Fabricamos e instalamos estruturas em todo território nacional' },
                  { icon: Handshake, title: 'Compromisso', desc: 'Agilidade e compromisso em todos os nossos projetos' }
                ].map((item, index) => (
              ...
              <blockquote className="bg-gray-50 p-6 rounded-2xl border-l-4 border-red-600 italic">
                <p className="text-gray-700 mb-4">
                  &ldquo;Só aqueles que arriscam ir longe demais podem descobrir até onde é possível chegar.&rdquo;
                </p>
      ...
      <section id="gallery" className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Galeria de Obras</h2>
            <p className="text-lg text-gray-600">Conheça alguns dos nossos projetos realizados</p>
          </div>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                {[
                  ...
                  { icon: 'envelope', title: 'Email', info: 'contato@embrafer.com' },
                  { icon: 'map-pin', title: 'Localização', info: 'Balsas - MA' }
                ].map((contact, index) => (
      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="text-2xl font-bold text-red-600 mb-4">EMBRAFER</h3>
              <p className="text-gray-300">Estruturas Metálicas de qualidade em Balsas MA</p>
            </div>
          ...
          <div className="border-t border-gray-700 pt-8 text-center text-gray-300">
            <p>&copy; 2025 Embrafer - Estruturas Metálicas. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
